        ...
        <div class="text-muted small">
            ...
            <?php endif; ?>
                        ...
                        <?php if (isset($_SESSION['user_id']) && $comment['user_id'] == $_SESSION['user_id']): ?>
                            <a href="<?= $baseUrl ?>php/admin/edit_comment.php?id=<?= $comment['id'] ?>&type=asset" class="btn btn-link text-decoration-none">Edit</a>
                        <?php endif; ?>
                                ...
                                <div class="card mb-2 animate__animated animate__fadeIn" id="reply-<?php echo $reply['id']; ?>" style="max-width: 100%;">
                                    <div class="card-body">
                                        ...
                                        <?php if (isset($_SESSION['user_id']) && $reply['user_id'] == $_SESSION['user_id']): ?>
                                            <a href="<?= $baseUrl ?>php/admin/edit_comment.php?id=<?= $reply['id'] ?>&type=asset" class="btn btn-link text-decoration-none">Edit</a>
                                        <?php endif; ?>
